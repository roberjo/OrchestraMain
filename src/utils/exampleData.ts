...
export const EXAMPLE_AMERICAN_ORCHESTRA: ExampleOrchestraConfig = {
  ...
  musicians: [
    // Concertmaster
    { id: generateId('mus'), name: 'Concertmaster', instrument: 'Violin I', chair: 1, section: 'strings' },
    // Violin I (8 total)
...
export const EXAMPLE_CONCERT_BAND: ExampleOrchestraConfig = {
  ...
  musicians: [
    ...
    // Bass Clarinet (1)
    { id: generateId('mus'), name: 'Bass Clarinet', instrument: 'Clarinet', chair: null, section: 'woodwinds' },
    // Saxophone Alto (2)
    ...Array.from({ length: 2 }, (_, i) => ({
      id: generateId('mus'),
...
export const EXAMPLE_CHAMBER_ORCHESTRA: ExampleOrchestraConfig = {
  ...
  musicians: [
    ...
    // Bass (1)
    { id: generateId('mus'), name: 'Bass', instrument: 'Bass', chair: 1, section: 'strings' },
    // Flute (1)
